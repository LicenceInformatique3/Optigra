...
enum const_edit{EDIT_NONE,EDIT_ADD_CURVE,EDIT_MOVE_CURVE,EDIT_REMOVE_CURVE,EDIT_ADD_CONTROL,EDIT_MOVE_CONTROL,EDIT_REMOVE_CONTROL,EDIT_MOVE_CLIP,EDIT_RESET_CLIP,EDIT_LAST};
enum const_mode{BSP_FIRST,BSP_OPEN,BSP_CLOSE,BSP_PROLONG,BSP_FILL,BSP_CLIP,BSP_LAST};
